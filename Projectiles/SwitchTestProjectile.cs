...
namespace AlarmMod.Projectiles
{
    ...
    public class SwitchTestProjectile : ModProjectile
    {
        ...
        public override string Texture => "AlarmMod/Projectiles/SwitchTestProjectile1";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>(CurrentAttack == 0 ? "AlarmMod/Projectiles/SwitchTestProjectile1" : "AlarmMod/Projectiles/SwitchTestProjectile2").Value;
